...
func TestSuccessStringMissingNotStrict(t *testing.T) {
	type testStruct struct {
		StringField string `zip:"testKeyMissing"`
	}
	v := testStruct{}

	err := Load(&v, &mockProvider, false)
...
func TestSuccessStringMissingStrictDefaultValue(t *testing.T) {
	...
	type testStruct struct {
		StringField string `zip:"testKeyMissing" zip-default:"abcdef"`
	}
	v := testStruct{}
...
func TestSuccessStringNoStrictNoDefault(t *testing.T) {
	type testStruct struct {
		StringField string `zip:"testStringKey"`
	}
	v := testStruct{}
...
func TestSuccessStringNoStrictDefault(t *testing.T) {
	type testStruct struct {
		StringField string `zip:"testStringKey" zip-default:"abcd"`
	}
	v := testStruct{}
